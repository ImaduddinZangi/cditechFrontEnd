...
const TreatmentPlantDigesterPropertiesForm: React.FC<TreatmentPlantDigesterPropertiesFormProps> = ({ updateProperties, properties }) => {
    ...
    return (
        <>
            ...
            <InputField label="Digester Dimensions" value={digesterDimensions} fieldType="text" onChange={(e) => setDigesterDimensions(e.target.value)} className="col-span-1" placeholder='123 x 123 x 123' />
