...
interface GreaseTrapPropertiesFormProps {
    updateProperties: (key: string, value: any) => void;
    properties: Record<string, any>;
}

const GreaseTrapPropertiesForm: React.FC<GreaseTrapPropertiesFormProps> = ({ updateProperties, properties }) => {
...
export default GreaseTrapPropertiesForm;
