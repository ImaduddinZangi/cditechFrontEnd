    ...
    return (
        <>
            ...
            <SelectField
                ...
                className="col-span-1"
            />
            <InputField label="Internal Pipe Diameter (inches)" value={internalPipeDia} fieldType="text" onChange={(e) => setInternalPipeDia(e.target.value)} className="col-span-1" />
            ...
            <InputField label="Drain Dimensions (Depth*Width*Length in feet)" value={drainDimensions} fieldType="text" onChange={(e) => setDrainDimensions(e.target.value)} className="col-span-1" />
            <SelectField
                label="Duty"
                value={duty}
            ...
            <SelectField
                ...
                className="col-span-1"
            />
            <InputField label="Connected Asset Line Color (Hex)" value={connectedAssetLineColor} fieldType="text" onChange={(e) => setConnectedAssetLineColor(e.target.value)} className="col-span-1" />
